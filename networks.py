...
class unetDecoder(nn.Module):
    def __init__(self,nClasses):
        ...
        seedChannels = 256#128
        self.conv4 = unetConv3(seedChannels*2,128,True) ; seedChannels = 128 #seedChannels//4,True)  ; seedChannels//=4
    ...
    def forward(self,c5,c4,c3,c2,c1):
        ...
        x = torch.sigmoid(self.final(self.upTrans1(x)))
        return x        
